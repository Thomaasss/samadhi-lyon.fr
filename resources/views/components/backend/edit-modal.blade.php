        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div class="relative p-6 flex-auto">
                <p class="my-4 text-lg leading-relaxed">
                    Voulez-vous soumettre la modification de {{ $intitule }} ?
                </p>
...
<div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-delete">
    <div class="relative w-auto my-6 mx-auto max-w-3xl">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div class="relative p-6 flex-auto">
                <p class="my-4 text-lg leading-relaxed">
                    Voulez-vous soumettre la suppression de {{ $intitule }} ?
                </p>
                <input type="text" name="imgStatus" value="1" hidden>
            </div>
            <!--footer-->
