<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" enctype="multipart/form-data" action="{{ route('therapies.store') }}" class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                @csrf
                    ...
                    <div class=" relative ">
                        ...
                        <div class="flex flex-nowrap">
                            <div class="shadow-lg rounded-2xl m-auto w-3/12 pl-2">
                                <div class="p-8">
                                    <x-backend.filepond-script intitule="Image de la thérapie" />
                                </div>
                            </div>
                ...
                <x-backend.create-modal intitule="une nouvelle thérapie" />
            </form>
        </div>
    </div>
                ...
                $( "#addTarif").click(function() {
                    if(foo < 10) {
                        ...
                        $('#tarifsContainer').append('<div id="tarifCard-'+ foo +'" class="tarifCard relative m-2 flex flex-col px-4 py-6 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">\n' +
                            ...
                            '                                                        cardId="'+ foo +'"\n' +
                            '                                                    >\n' +
                            '                                                        <svg id="deleteIcon" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">\n' +
                    ...
                    $(".removeTarif").on('click', function() {
                        $('#tarifCard-'+$(this).attr('cardId')).remove();
                    });
                });
            });
        </script>
