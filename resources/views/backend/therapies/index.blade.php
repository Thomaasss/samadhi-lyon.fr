                                    ...
                                    >
                                        <div class="relative">
                                            <input
                                                ...
                                                placeholder="Intitulé d'une thérapie..."
                                                value="{{$filter}}"
                                            />
                                        </div>
                                        ...
                                        <a href="/backend/therapies" class="flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-zen-brown-600 rounded-lg shadow-md hover:bg-zen-brown-700 focus:outline-none focus:ring-2 focus:ring-zen-brown-500 focus:ring-offset-2 focus:ring-offset-zen-brown-200" type="submit">
                                            Réinitialiser
                                        </a>
                                    </form>
                                </div>
                                        ...
                                        @foreach($therapies as $therapie)
                                            <tr>
                                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                    <a href="/backend/therapies/{{ $therapie->id }}" class="text-gray-900 whitespace-no-wrap flex items-center">
                                                        <span class="relative inline-block px-3 py-1 font-semibold text-zen-lightblue-900 leading-tight py-2 mr-4">
                                                            ...
                                                            <span class="relative">
                                                                <span class="text-3xl {{ $therapie->icone->intitule }}" style="color:#577377;"></span>
                                                            </span>
                                                        </span>
                                                        <span class="mb-1">{{ $therapie->intitule }}</span>
                                                    </a>
                                                </td>
                                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                    <a class="flex items-center" href="/backend/profs/{{ $therapie->professionnel_id }}">
                                                        <div class="flex-shrink-0">
                                                            <div class="block relative">
                                                                @if($therapie->prof->image)
                                                                    <img alt="profil" src="{{ asset($therapie->prof->image) }}" class="mx-auto object-cover rounded-full h-10 w-10 "/>
                                                                @else
                                                ...
                                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                    <span class="text-gray-900 whitespace-no-wrap momentJs description" data-tippy-content="Il y a {{ $therapie->age }}">
                                                        {{ $therapie->updated_at }}
                                                    </span>
                                                </td>
                                                <td class="px-5 py-5 border-b border-gray-200 bg-white">
                                                    <div class="flex item-center justify-center">
                                                        ...
                                                        >
                                                            <a
                                                                href="/backend/therapies/{{ $therapie->id }}"
                                                            >
                                                        ...
                                                        <button
                                                            type="button"
                                                            onclick="toggleModal({{ $therapie->id }}, '{{ $therapie->intitule }}')"
                    ...
                    @push('scripts')
                        <script type="text/javascript">
                            function toggleModal(id, intitule){
                                ...
                                document.getElementById("delete-modal-phrase").innerHTML = "Voulez-vous soumettre la suppression de la thérapie " + intitule + " ?";
                                $("#delete-modal-link").attr('href', "/therapies/"+ id +"/delete");
                            }
                        </script>
                    @endpush
                </div>
